        ...
        agent=FBcprAuxAgentConfig(
            ...
            model=FBcprAuxModelConfig(
                ...
                archi=FBcprAuxModelArchiConfig(
                    ...
                    z_dim=256,
                    norm_z=True,
                    z_hand_low=[-1.0, -1.0, -1.0],
                    z_hand_high=[1.0, 1.0, 1.0],
                    z_hand_obs_key='privileged_state',
                    z_hand_obs_idxs=[85, 86, 87],
                    ...
                    b=BackwardArchiConfig(name='BackwardArchi', hidden_dim=256, hidden_layers=1, norm=True, input_filter=DictInputFilterConfig(name='DictInputFilterConfig', key=['state', 'privileged_state']), z_hand_dim=3, hand_hidden_dim=256, hand_hidden_layers=1, hand_input_filter=DictInputFilterConfig(name='DictInputFilterConfig', key='privileged_state'), z_hand_scale=4.0),
                    ...
                    discriminator_use_z_body_only=True,
